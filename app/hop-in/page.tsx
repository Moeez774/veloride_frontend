...
const page = () => {
  ...
  return (
    <div className='inter flex font-medium flex-col'>
      ...
      <div className='bg-[#E5EAE8] pb-36'>
        <LiveTracker />
      </div>

      <div className='flex flex-col items-center w-full gap-12'>
        <div className='flex flex-col items-center w-full gap-12 px-4 sm:px-8 md:px-4 lg:px-12'>
          <div ref={ref2} className='inter font-medium max-w-6xl mb-20 px-7 sm:px-10 py-10 md:py-12 lg:py-16 lg:px-16 xl:px-20 relative -mt-36 w-full shadow-xl bg-[#fefefe] rounded-2xl'>

            <div className='w-full flex flex-col gap-8 md:gap-12'>
              <div className='flex justify-between'>
                <div className='flex flex-col gap-1'>
                  <h1 className={`text-sm font-semibold text-[#00563c] ease-out transition-all duration-1000 ${inView2? 'translate-x-0 opacity-[1]': '-translate-x-2 opacity-0'}`}>Ride With Ease</h1>
                  <h1 className={`text-[28px] sm:text-[30px] lg:text-[35px] leading-[42px] sm:leading-[45px] sm:w-96 text-[#202020] ${inView2? 'translate-x-0 opacity-[1]': '-translate-x-6 opacity-0'} ease-out transition-all duration-1000 delay-200`}>Experience the Future of Ride Sharing</h1>
                </div>

                <h1 className={`text-[13px] hidden md:block w-80 lg:w-96 ${inView2? 'translate-x-0 opacity-[1]': '-translate-x-6 opacity-0'} ease-out transition-all duration-1000 delay-500 pt-6 text-[#5b5b5b]`}>Explore smarter travel options with features like AI-driven ride suggestions, saved routes, and voice search for a seamless journey.</h1>
              </div>
          ...
          <div ref={ref3} className='max-w-6xl font-medium w-full items-center gap-10 mx-auto flex flex-col md:flex-row md:justify-between md:gap-4'>
            <div className='flex w-full lg:w-auto px-3 sm:px-0 md:px-4 lg:px-0 flex-col gap-1'>
              <h1 className={`${inView3? 'translate-x-0 opacity-[1]': '-translate-x-2 opacity-0'} ease-out transition-all duration-800 text-sm font-semibold text-[#00563c]`}>Live routing</h1>
              <h1 className={`${inView3? 'translate-x-0 opacity-[1]': '-translate-x-6 opacity-0'} ease-out transition-all duration-1000 delay-300 text-[35px] leading-[45px] w-72 text-[#202020]`}>Smart Routes,
                Less Wait</h1>
              <h1 className={`${inView3? 'translate-x-0 opacity-[1]': '-translate-x-6 opacity-0'} ease-out transition-all duration-800 delay-700 mt-2 max-w-md md:max-w-sm w-full lg:w-80 text-[#5b5b5b] text-xs`}>Our system uses live traffic data and intelligent algorithms to match carpools and suggest the fastest, most efficient routes in real time.</h1>
            </div>

            <img className={`${inView3? 'translate-y-0 opacity-[1]': '-translate-x-6 opacity-0'} ease-out transition-all duration-800 delay-1100 w-[300px] sm:w-[350px] lg:w-[400px]`}src='/Images/Navigation-amico.svg' />
          </div>

          {/* //Why us */}
          <div ref={ref4} className='max-w-4xl flex flex-col mx-auto my-20 w-full'>
            <h1 className={`${inView4? 'translate-y-0 opacity-[1]': 'translate-y-6 opacity-0'} ease-out transition-all duration-800 text-sm font-semibold text-center text-[#00563c]`}>Why us</h1>
            <h1 className={`${inView4? 'translate-y-0 opacity-[1]': 'translate-y-8 opacity-0'} ease-out transition-all duration-700 delay-300 text-3xl leading-[45px] text-center px-4 mt-1.5 text-[#202020]`}>Why they prefer Veloride</h1>
            ...
            <div className='w-full flex flex-col gap-3 sm:px-6 md:px-0 lg:gap-6 mt-8'>
              <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-6'>
                <div className={`rounded-2xl flex flex-col gap-10 py-8 px-6 sm:p-10 bg-[#E5EAE8] ${inView4? 'translate-x-0 opacity-[1]': '-translate-x-5 opacity-0'} ease-out transition-all duration-1000 delay-800`}>
                  <h1 className={`${inView4? 'translate-x-0 opacity-[1]': '-translate-x-4 opacity-0'} ease-out transition-all duration-1500 delay-900 font-semibold text-6xl text-[#00563c]`}>10k+</h1>
                  <h1 className={`${inView4? 'translate-x-0 opacity-[1]': '-translate-x-4 opacity-0'} ease-out transition-all duration-1500 delay-1100 text-lg font-semibold text-[#202020]`}>Connected users on Veloride across all Pakistan.</h1>
                </div>

                <div className={`${inView4? 'translate-y-0 opacity-[1]': '-translate-y-6 opacity-0'} ease-out transition-all duration-1000 delay-1300 rounded-2xl flex flex-col gap-10 py-8 px-6 sm:p-10 bg-[#E5EAE8]`}>
                  <h1 className={`${inView4? 'translate-y-0 opacity-[1]': '-translate-y-4 opacity-0'} ease-out transition-all duration-800 delay-1500 text-lg font-semibold text-[#202020]`}>EcoStats tracks your carbon savings and eco-rewards.</h1>
                  ...
                  <div className={`lg:mx-8 flex items-center gap-2 ${inView4? 'translate-y-0 opacity-[1]': '-translate-y-4 opacity-0'} ease-out transition-all duration-800 delay-1700`}>
                    ...
                    <div className='w-14 h-14 bg-[#202020] rounded-full flex items-center justify-center'><Trophy size={25} color='#fefefe' /> </div>
                  </div>
                </div>
              </div>

              {/* //Chart */}
              <div className={`${inView4? 'translate-y-0 opacity-[1]': 'translate-y-4 opacity-0'} ease-out transition-all duration-1000 delay-1900 bg-[#E5EAE8] flex md:items-center gap-14 md:gap-0 flex-col md:flex-row md:justify-between w-full pt-12 md:pt-8 px-3 sm:px-8 lg:px-10 rounded-2xl`}>
                <div className={`${inView4? 'translate-y-0 opacity-[1]': 'translate-y-4 opacity-0'} ease-out transition-all duration-800 delay-2100 px-3 sm:px-0 flex flex-col gap-3`}>
                  <h1 className='font-semibold text-3xl text-[#202020]'>Journey So Far</h1>
                  <h1 className='text-[#5b5b5b] text-xs sm:w-96 md:w-70'>See how thousands have already trusted us, A growing platform built for smarter, greener travel.</h1>
                </div>
        ...
        <div ref={ref6} className='max-w-7xl w-full flex flex-col sm:flex-row gap-8 md:gap-4 justify-between mx-auto my-10 px-6'>
          ...
          <div className='max-w-3xl w-full'>
            <h1 className={`text-sm font-semibold text-center text-[#00563c] ${inView6? 'translate-y-0 opacity-[1]': 'translate-y-4 opacity-0'} ease-out transition-all duration-800`}>Our aim</h1>
            <h1 className={`${inView6? 'translate-y-0 opacity-[1]': 'translate-y-8 opacity-0'} ease-out transition-all duration-800 delay-200 text-3xl leading-[45px] text-center mt-1.5 text-[#202020]`}>Smart Rides for All</h1>
            <h1 className={`${inView6? 'translate-y-0 opacity-[1]': 'translate-y-4 opacity-0'} ease-out transition-all duration-800 delay-500 font-medium text-[#5b5b5b] text-center text-[13px] md:text-sm mt-4`}>To build an AI-powered carpooling platform that’s truly affordable, incredibly smooth, and accessible for everyone no matter who they are or where they go.</h1>
          </div>

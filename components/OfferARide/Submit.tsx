    ...
    return (
        <>
            ...
            <div className='w-full flex justify-center sm:px-10 items-center'>
                <ScrollArea style={{ opacity: currStep === 5 ? '1' : '0', transform: currStep === 5 ? 'scale(1)' : 'scale(0.5)', transition: 'all 0.2s ease-in-out' }} className="h-[100vh] sm:h-[95vh] py-10 bg-[#fefefe] flex flex-col gap-6 w-full sm:max-w-xl lg:max-w-5xl rounded-md border p-4">

                    <div className='top-0 z-[200] sticky bg-white py-4'>

        ...
        <div className={`inter flex flex-col my-10 gap-6 max-w-[76rem] sm:px-4 lg:px-8 xl:px-0 w-full mx-auto ${toggleTheme ? 'text-[#fefefe]' : 'text-[#202020]'}`}>
            ...
            <div className='relative w-full flex flex-col gap-4'>
                <div className={`relative flex justify-center w-full overflow-x-hidden items-center`}>
                    ...
                    <div ref={detailsRef} className={`${toggleTheme ? 'bg-[#1e1e1e]' : 'bg-[#fefefe]'} rounded-lg p-4 transition-all ease-out duration-500 shadow-lg ${showDetails ? 'translate-x-0' : 'translate-x-[28rem]'} -translate-y-16 right-3 w-[25em] absolute z-[30]`}>

                        {details && <div className='inter w-full flex gap-6 flex-col justify-between gap-1.5'>
                            ...
                            <div className='flex items-center justify-between gap-3'>
                                ...
                                <div className={`${toggleTheme ? 'bg-[#048c64] hover:bg-[#0048c64cc]' : 'bg-[#00563c] hover:bg-[#00563ccc]'} p-2 cursor-pointer transition-all duration-200 rounded-full`}><ArrowRight size={20} color='#fefefe' className='-rotate-45' /></div>
                            </div>

                            <div className='flex justify-between items-end w-full gap-2'>
                                <div className='flex gap-2 w-4/5 font-medium text-sm flex-col'>
                                    ...
                                    <h1 className='flex items-center gap-1'><FaCoins size={17} color={toggleTheme ? '#048c64' : '#00563c'} className='mt-1' /> Fare: Rs.{details.budget.totalBudget} </h1>
                                </div>
                        ...
                        <div className='lg:w-fit flex justify-between items-start gap-2'>
                            ...
                            <TooltipProvider>
                                <Tooltip open={showRatedDrivers} onOpenChange={() => {
                                    ...
                                    <TooltipContent className='inter flex flex-col gap-2 py-3'>
